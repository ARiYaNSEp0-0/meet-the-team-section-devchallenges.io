<a href="https://devchallenges.io/" target="_blank"><img src="./src/images/logos/devchallenges-logo.svg" alt="dev challenges logo" /></a>

# <a href="https://devchallenges.io/challenge/meet-the-team-section-challenge">Meet the Team Section</a>
...
3. Run preview command with (`npm run preview`)
4. Enjoy :)
...
1. Download or clone this project
2. Install dependencies with (`npm install`)
3. Run dev command with (`npm run dev`)
4. Extend </>
## Goals
The goals of this project are to help you:

- Practice building Grid layout 
